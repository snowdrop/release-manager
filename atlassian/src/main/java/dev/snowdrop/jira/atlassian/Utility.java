...
public class Utility {
    public static final String TEMPLATE = "The snowdrop team is really pleased to contact you as we will release in 12 weeks a new Snowdrop BOM based on the following Spring Boot version: 2.3.0.RELEASE\n" +
