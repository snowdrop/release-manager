...
public class CPaaSReleaseFactoryTest {
    ...
    @Test
    public void checkReleaseTemplateParsingDrNoSecurity() throws Throwable {
    ...
    @Test
    public void checkReleaseTemplateParsingErSecurity() throws Throwable {
        List<CVE> cveList = getCVEListForTesting();
