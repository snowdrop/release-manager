...
//    }
    ...
    public CPaaSReleaseFile createCPaaSReleaseFromTemplate(String release, String previousRelease, boolean isErCr, boolean isSecurityAdvisory, List<CVE> cveList) throws IOException {
